...
class myAgent():
    ...
    # Generates opponent's actions from this state.
    ...
    # Carry out a given action on this state and return True if my agent reward received.
    ...
    # Carry out a given action on this state and return True if opponent's agent reward received.
    ...
    # Computes the total number of counters of this color.
    ...
    # Computes the point from this state.
    ...
    # Computes the features from this state.
    ...
    # Computes the opponent's score from this state.
